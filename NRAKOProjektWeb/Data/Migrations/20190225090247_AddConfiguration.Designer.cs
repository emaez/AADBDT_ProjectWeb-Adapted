...
namespace NRAKOProjektWeb.Data.Migrations
{
    ...
    [Migration("20190225090247_AddConfiguration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1cbe4f52-b6f7-478d-a443-eeff033b922e",
                            ConcurrencyStamp = "98735956-990b-4249-9e0d-74fcc3793bcf",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "71b15592-c00d-4925-ac19-f47dd2ff615d",
                            ConcurrencyStamp = "2c0e79c2-95e7-4761-ba44-fa8e93791c3c",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("NRAKOProjektWeb.Models.ConfigurationEntry", b =>
                {
                    b.Property<string>("Name")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NRAKOProjektWeb.Models.LogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NRAKOProjektWeb.Models.LogEntry", b =>
                {
                    b.HasOne("NRAKOProjektWeb.Models.NRAKOUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
