...
namespace NRAKOProjektWeb.Data.Migrations
{
    ...
    [Migration("20190219153411_AddPhotosAndHashtags")]
    partial class AddPhotosAndHashtags
    {
            ...
            modelBuilder.Entity("NRAKOProjektWeb.Models.Photo", b =>
                {
                    ...
                    b.Property<int>("NRAKOUserId");

                    b.Property<string>("NRAKOUserId1")
                        .IsRequired();

                    b.HasKey("Id");

                    b.HasIndex("NRAKOUserId1");
